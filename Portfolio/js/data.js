...
const DATA = {
  ...
  /* ---------- ABOUT ---------- */
  about: [
    "I'm Hang Muykhorng, an incoming Year 5 student in Applied Mathematics and Statistics (Data Science) at the Institute of Technology of Cambodia. I finished Year 4 ranked first in my cohort with a GPA of 4.00 — but the number I'm prouder of is the count of projects I shipped alongside it.",

    "My path into AI started with curiosity rather than a plan. I wanted to know how a machine could look at an image and recognise a face, how a model could read Khmer and answer back, how a traffic light could learn to be less annoying. Every question turned into a project, and every project taught me something the lecture notes couldn't.",

    "Today my work sits at the intersection of research and practice. I've trained computer vision and reinforcement learning models, built end-to-end data pipelines and BI dashboards, worked with LLMs and RAG systems for Khmer-language education, and wired up ESP32 boards for cyber-physical control. I present that work when I can — most recently at IEEE TIC 2026 in Malaysia and the NUS Young Fellowship Program in Singapore.",
    ...
    "I'm still early, and I know it. My aspiration is to become an AI researcher and technology entrepreneur who builds things that make sense for Cambodia and for people like the ones I grew up with. For now, I'm doing the only thing that reliably gets me there: learning in public, collaborating generously, and building the next thing."
  ],
  ...
  phones: [
    { name: "Smart",    number: "0128819",    logo: "assets/images/smart.png" },
    { name: "Cellcard", number: "0966178945", logo: "assets/images/cellcard.png" }
  ],
  ...
  timeline: [
    ...
    { year: "2024", title: "Learning to build",                   text: "Programming coursework in C/C++/OOP at ETEC, plus web fundamentals — the year projects started leaving my laptop." },
    { year: "2025", title: "Competitions & a startup",            text: "CATALYST champion, YFS Phnom Penh winner, Singapore on scholarship, Honda YES top 15 — and co-founding RielAds." },
      ...
      projects: [
        {
          ...
          summary: "An AI-powered marketing analytics platform that helps Cambodian SMEs measure and optimise their advertising performance — turning scattered ad spend into decisions they can actually defend.",
    ...
    },
    {
      ...
      projects: [
        ...
        },
        {
          ...
          summary: "A complete online banking simulation covering accounts, transfers, transaction history, and role-based access — my deep dive into building software where correctness is non-negotiable.",
        ...
        },
        {
          ...
          type: "Machine Learning · Healthcare",
          summary: "Diagnostic classification on cytology features, comparing model families and prioritising recall — because in screening, missing a case is the expensive mistake.",
  ...
  awardGroups: [
    {
      ...
      items: [
        { name: "Ranked #1 in Year 4 — GPA 4.00", org: "Institute of Technology of Cambodia", year: "2026", note: "First in cohort, Applied Mathematics & Statistics (Data Science).", photos: [] },
        { name: "Champion Team — NUS Young Fellowship Program 2026", org: "National University of Singapore", year: "2026", note: "Under the theme \"AI and Graduate Research\".", photos: [] },
        { name: "Best Presentation Award — IEEE TIC 2026", org: "IEEE · Kuala Lumpur, Malaysia", year: "2026", note: "For AI research on inclusive Khmer education.", photos: [] },
        { name: "Champion — CATALYST 2025 Pitching Competition", org: "CATALYST", year: "2025", note: "AI application in the healthcare sector.", photos: [] },
        { name: "Winner — YFS Phnom Penh Rapid Pitching Competition", org: "Young Founders Summit", year: "2025", note: "Earned full sponsorship to compete in Singapore.", photos: [] },
        { name: "Top 15 Finalist — Honda Young Engineers & Scientists Award", org: "Honda Foundation", year: "2025", note: "", photos: [] },
        { name: "Gold Medal — ASPIRATION Project", org: "Ministry of Education, Youth and Sport", year: "2021", note: "Awarded with certificates.", photos: [] },
        { name: "Selected for NUS Mathematics Track 2025", org: "National University of Singapore", year: "2025", note: "", photos: [] },
        { name: "2 Machine Learning projects presented", org: "14th Scientific Day, ITC", year: "2025", note: "", photos: [] }
      ]
    },
    {
      id: "international",
      ...
      items: [
        { name: "Cambodia Representative & Champion — NUS Young Fellowship 2026", org: "Singapore", year: "2026", note: "Represented Cambodia and won with my team on the AI and Graduate Research theme.", photos: [] },
        { name: "Best Presentation Award — IEEE TIC 2026", org: "Kuala Lumpur, Malaysia", year: "2026", note: "My first international conference presentation.", photos: [] },
        { name: "YFS 2025 Full Scholarship Awardee", org: "Young Founders Summit · Singapore", year: "2025", note: "Fully sponsored to compete after winning the Phnom Penh round.", photos: [] },
        { name: "UNESCO UNITWIN Data Sciences Camp", org: "Phnom Penh, Cambodia", year: "2023", note: "Completed the standard level.", photos: [] }
      ]
    },
    {
      id: "leadership",
      title: "Leadership",
      items: [
        { name: "Leader — Data & Business Analytics Student Club", org: "Institute of Technology of Cambodia", year: "2025 – present", note: "Organising sessions, mentoring juniors, and keeping the club's projects moving.", photos: [] },
        { name: "Marketing & Sales Intern", org: "Spring Education Center", year: "2024", note: "My first look at how a business actually finds its customers.", photos: [] },
        { name: "Team Leader — Student Sharing Knowledge Forum", org: "The Westline School", year: "2022", note: "Won the debate in a team leader role.", photos: [] },
    ...
    },
    {
      ...
      items: [
        { name: "IELTS — Band 7.5", org: "GEP 12 at ACE", year: "2023", note: "", photos: [] },
        { name: "HSK Level 3", org: "Cambodia-China University of Technology and Science", year: "2024", note: "", photos: [] },
        { name: "UNESCO UNITWIN Data Science Camp", org: "UNESCO UNITWIN", year: "2023", note: "Standard level completed.", photos: [] },
        { name: "AI Bootcamp — 100% Full Scholarship", org: "AI Bootcamp", year: "2025", note: "Awarded a full scholarship.", photos: [] },
        { name: "HTML, CSS & Tailwind CSS", org: "I.T Training Course", year: "2025", note: "", photos: [] },
        { name: "Basic / Advance / C / C++ / OOP & Project Course", org: "ETEC", year: "2024", note: "", photos: [] },
        { name: "Microsoft Word, Excel & PowerPoint", org: "Multi-Skilled Center", year: "2016", note: "Where it all started.", photos: [] }
      ]
    }
  ],
  ...
  volunteering: [
    ...
    {
      org: "APYE",
      role: "Airport Pick-up & Hospitality Team",
      year: "2023",
      summary: "Welcomed international participants to Cambodia — first faces at the airport, first impressions of the country.",
      duties: ["Airport reception and transfers", "Hospitality and participant care"],
      photos: []
    },
    {
      org: "Tech for Kids",
    ...
    },
    {
      ...
      year: "9–10 July 2025",
      summary: "Hosted the AMS 1st generation thesis defense across two days — the first cohort of my own department defending their work.",
